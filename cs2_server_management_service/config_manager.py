...
class ConfigManager():
    ...
    def _init_defaults(self):
        ...
        self._instance._steamcmd_executable: str = ConfigManager.DEFAULT_STEAMCMD_EXECUTABLE
        self._instance._server_install_directory: str = ConfigManager.DEFAULT_SERVER_INSTALL_DIRECTORY
    ...
    def _create_arg_parser() -> argparse.ArgumentParser:
        ...
        parser.add_argument('--steam_username', dest='steam_username',
                            help='username used by steamcmd',
                            type=str, nargs='?', default=None
                            )
        parser.add_argument('--steam_password', dest='steam_password',
        ...
        parser.add_argument('--steamcmd', dest='steamcmd', 
                            help='overwrite default steamcmd executable', 
                            type=str, nargs='?', default=None
                            )
        parser.add_argument('--server_install_directory', dest='server_install_directory', 
